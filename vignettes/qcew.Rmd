...
The QCEW API is structured differantly than the main BLS API. For this reason, the blscrapeR package includes a function for extracting these data.
...
* The `slice` argument defines the QCEW data slice we would like to querry. The current options are "industry", "area", and "size." One of these terms should be passed in quotes.
