...
colnames(df.sp) <- c("year", "period", "periodName", "footnotes", "date", "hourly_cost", "pct_of_wages")
...
df.sp <- spread(df, seriesID, value)
colnames(df.sp) <- c("year", "period", "periodName", "footnotes", "date", "pct_paid_vacation", "pct_health_ins")
