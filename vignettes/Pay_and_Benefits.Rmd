...
rename(df.sp, "hourly_cost"=CMU1030000000000D, "pct_of_wages"=CMU1030000000000P)
...
# Spread series ids and rename columns to human readable format.
df.sp <- spread(df, seriesID, value)
rename(df.sp, "pct_paid_vacation"=NBU10500000000000033030, "pct_health_ins"=NBU11500000000000028178)
